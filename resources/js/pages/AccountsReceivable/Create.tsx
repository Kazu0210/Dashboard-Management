    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-6 p-4 bg-background min-h-screen">
                <div className="mb-4">
                    <h2 className="text-3xl font-bold text-primary mb-1">Create Account Receivable</h2>
                </div>
                <div className="max-w-xl w-full mx-auto">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end gap-2 mt-2">
                            ...
                            <button type="submit" className="inline-flex items-center px-4 py-2 rounded bg-primary text-primary-foreground font-semibold shadow hover:bg-primary/90 transition-colors" disabled={processing}>Create</button>
                        </div>
                    </form>
                </div>
            </div>
