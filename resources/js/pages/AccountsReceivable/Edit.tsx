...
const EditAccountsReceivable = ({ record, clients = [] }: { record: any, clients?: { id: number, name: string }[] }) => {
    const { data, setData, put, processing, errors } = useForm({
        ...
        invoice_date: record.invoice_date || new Date().toISOString().slice(0, 10),
            ...
            <div className="space-y-6 p-4 bg-gray-50 min-h-screen">
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900">Edit Account Receivable</h2>
                            <p className="text-lg mt-1 text-gray-600">Update the record below.</p>
                        </div>
