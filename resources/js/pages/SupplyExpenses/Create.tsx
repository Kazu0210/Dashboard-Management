            ...
            <div className="flex min-h-screen bg-gray-50">
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="w-full max-w-2xl mt-8 p-6 bg-white rounded shadow">
                        <h1 className="text-2xl font-semibold mb-4">Create Supply Expense</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-end">
                                <button type="submit" disabled={submitting} className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-md font-semibold disabled:opacity-50">
